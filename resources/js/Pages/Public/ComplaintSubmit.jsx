...
export default function ComplaintSubmit({ districts: rawDistricts = [], departments: rawDepartments = [] }) {
    ...
    return (
        <PublicLayout>
            ...
            <div className="max-w-5xl mx-auto mb-8 bg-white/95 backdrop-blur-md rounded-2xl p-4 sm:p-5 shadow-sm border border-emerald-900/10">
            ...
            {/* Error Banners */}
            {errors.general && (
                <div className="mb-6 max-w-5xl mx-auto relative overflow-hidden bg-gradient-to-r from-red-50 via-rose-50 to-red-50 border-2 border-red-400 text-red-950 p-5 rounded-2xl shadow-md flex items-start gap-4 animate-shake">
            ...
            {errors.rate_limit && (
                <div className="mb-6 max-w-5xl mx-auto p-4 rounded-2xl bg-amber-50 border-2 border-amber-400 text-amber-950 flex items-start gap-3 shadow-sm">
